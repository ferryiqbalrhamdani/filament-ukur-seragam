...
class PduWanitaExporter extends Exporter
{
    ...
    {
        $body = 'Your pdu wanita export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
