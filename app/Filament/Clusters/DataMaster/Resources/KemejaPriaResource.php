...
use App\Filament\Clusters\DataMaster\Resources\KemejaPriaResource\Pages;
use App\Filament\Clusters\DataMaster\Resources\KemejaPriaResource\RelationManagers;

class KemejaPriaResource extends Resource
{
    ...
    protected static ?string $slug = 'kemeja-pria';
    ...
    {
        return [
            'index' => Pages\ListKemejaPrias::route('/'),
            'create' => Pages\CreateKemejaPria::route('/create'),
            'edit' => Pages\EditKemejaPria::route('/{record}/edit'),
        ];
    }
}
